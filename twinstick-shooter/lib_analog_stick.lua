...
function NewStick( Props )
		...
		Group.Border = display.newImage("gfx/pad.png")
		Group.Border.xScale = .5
		Group.Border.yScale = .5
		...
		-- for use images uncomment the line down and comment line up
		Group.Thumb = display.newImage("gfx/joy.png")
	...
	Group.Thumb.xScale = .5
	Group.Thumb.yScale = .5
